...
const ContactScreen = () => {
    return (
      <div>
      <div className="py-24 backdropse h-96" style={{ backgroundImage: `url(${background})`}}>
        <div className="px-3 mx-auto items-center content-center grid">
          <div className="relative z-10 justify-center text-center">
              ...
              <p className="block uppercase tracking-loose w-full text-white font-semibold font-raleway">
