...
const RegisterScreen = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      emailjs
        .sendForm("service_vnf567f", "template_txjuzpt", event.target, {
          name: name,
          email: email,
          password: password,
      ...
      if (
        ...
        err.response &&
        err.response.data &&
        err.response.data.message === "company already exists"
      ) {
    ...
    <div>
      ...
      <section className="bg-white">
        <div className="container mx-auto my-0 w-8/12 pt-10">
          ...
          <div className="or_with pl-5 mr-5 text-center relative my-5">
          ...
          <form className="mt-8" ref={form} onSubmit={handleSubmit}>
            ...
            <div className="w-6/12 inline-block pr-4 pb-4">
              ...
              >
                <option
                  className="text-sm font-lato text-gray-600 font-semibold"
                  value=""
                >
                  Country *
                </option>
            ...
            <div className="my-5 mr-3.5 text-center">
              <input
                className="w-5/12 text-raleway text-sm bg-green-600 hover:bg-green-700 text-white font-semibold py-2 rounded shadow-lg hover:shadow-xl transition duration-200"
                type="submit"
                name="yt0"
                value="Signup"
              ></input>
